<?php
  ...
  if ($view != ""){
    ...
    echo "<h3>$name1 Messages</3>";
    showProfile($view);
    echo <<<_END
      <form method='post' action='messages.php?view=$view'>
        <fieldset data-role="controlgroup" data-type="horizontal">
           <legend>Escribe aqui para enviar un mensaje</legend>
        ...
        <button data-transition='slide' type='submit' class="button is-dark">Enviar mensaje</button>
      </form><br>
 _END;
