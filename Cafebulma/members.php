<?php // Example 26-9: members.php
  ...
  if (isset($_GET['view']))
  {
    ...
    echo "<h3>$name Profile</3>";
    showProfile($view);
    echo "<a data-role='button' data-transition='slide' href='messages.php?view=$view'>view $name messages</a>";
    die("</div></body></html>");
  }
  ...
  echo "<h3 id='miembros'>Otros Miembros</3><ul>";
